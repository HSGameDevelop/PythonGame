...
#Python やその他の動的型付け言語では、Hex と FractionalHex を分離する必要はありません。
#代わりに Hex で動作するように FractionalHex 関数を記述し、FractionalHex クラスをスキップすることができます。
...
print(__name__) # 取りあえず、動いているかの確認用
